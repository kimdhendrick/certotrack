...
describe EquipmentPresenter do
  context '#assigned_to' do
    it 'should return location name' do
      ...
      EquipmentPresenter.new(location_assigned_equipment).assigned_to.should == 'Florida'
    end
    ...
    it 'should return employee name' do
      ...
      EquipmentPresenter.new(employee_assigned_equipment).assigned_to.should == 'Smith, John'
    end

    it 'should return Unassigned' do
      unassigned_equipment = create(:equipment, employee: nil, location: nil)

      EquipmentPresenter.new(unassigned_equipment).assigned_to.should == 'Unassigned'
    end
  end
end
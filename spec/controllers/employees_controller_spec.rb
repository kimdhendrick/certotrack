    ...
    context 'when certification user' do
      ...
      describe 'with valid params' do
        ...
        it 'redirects to the created employee' do
          ...
          flash[:success].should == "Employee Smith, John was successfully created."
        end
    ...
    context 'when certification user' do
      ...
      describe 'with valid params' do
        ...
        it 'redirects to the employee' do
          ...
          flash[:success].should == 'Employee Smith, John was successfully updated.'
        end
      end
    ...
    context 'when certification user' do
      ...
      context 'when destroy call succeeds' do
        ...
        it 'redirects to the employee list' do
          ...
          flash[:success].should == 'Employee Smith, John was successfully deleted.'
        end
      end

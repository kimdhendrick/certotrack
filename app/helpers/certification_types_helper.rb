module CertificationTypesHelper
  ...
  def assign_non_certified_employees_by_certification_type(params = {})
    ...
    @non_certified_employees = EmployeeListPresenter.new(employees_collection).sort(params)
  ...
  def assign_certifications_by_certification_type(params = {})
    ...
    @certifications = CertificationListPresenter.new(certifications_collection).sort(params)

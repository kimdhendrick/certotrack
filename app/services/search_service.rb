class SearchService
  def search(active_record_relation, params)
    ...
    query = _build_name_or_serial_number_query(params, query, query_params)
  ...
  def _build_employee_or_location_query(params, query, query_params)
  ...
  def _build_name_or_serial_number_query(params, query, query_params)
